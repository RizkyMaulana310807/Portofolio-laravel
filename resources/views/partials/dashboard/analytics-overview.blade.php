...
<div class="flex w-1/2 flex-col bg-bright p-4 gap-8 rounded-2xl hover:shadow-2xl hover:shadow-ink-black transition-all duration-500 ease-in-out">
    <!-- top section -->
    <div class="flex flex-row w-full">
        ...
        <div class="flex flex-col w-1/2 justify-between p-4">
            ...
            <div>
                <div>
                    <h1 class="font-quicksand font-bold text-4xl flex flex-row gap-2 items-center"><i data-lucide="eye"></i>44.4k</h1>
                </div>
                <div class="flex">
                    <h1 class="bg-red-400/50 flex gap-2 p-1 rounded-full px-2 text-red-500/80 text-medium font-quicksand font-bold border border-red-500/80"><i data-lucide="trending-down" class="text-xs"></i>37%
                    </h1>
                </div>
            </div>
        </div>
